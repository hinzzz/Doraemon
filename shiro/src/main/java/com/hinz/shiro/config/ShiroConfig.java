package com.hinz.shiro.config;

import com.hinz.shiro.dao.PermissionMapper;
import com.hinz.shiro.dao.RoleMapper;
import com.hinz.shiro.entity.Role;
import com.hinz.shiro.entity.User;
import com.hinz.shiro.service.IUserService;
import com.hinz.shiro.util.ByteSourceUtils;
    ...
    public AuthorizingRealm myShiroRealm(HashedCredentialsMatcher hashedCredentialsMatcher) {
        AuthorizingRealm  myShiroRealm = new AuthorizingRealm() {
            ...
            protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principal) {
                ...
                LOGGER.info("用户：{}, 角色有{}个, 所属角色{}", user.getUsername(), roles.size(),roles);
